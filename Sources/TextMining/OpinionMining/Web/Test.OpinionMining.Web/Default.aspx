<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Test.OpinionMining.Web._Default" %>
...
<head runat="server">
    <title>Opinion-Mining test</title>
                    ...
                    <tr>
                        ...
                        <td style="padding: 2px; border: solid 1px silver; text-align: center;">
                            ...
                            <asp:Button ID="execInIFrameButton" runat="server" Text="выполнить" 
                                ...
                                Font-Size="XX-Small" style="cursor: pointer;" Width="135px"/>
                            <hr />
                            <asp:DropDownList ID="outputTypeDropDownList" runat="server" Font-Size="XX-Small" 
                    ...
                    <tr>
                        <td style="padding: 2px; border: solid 1px silver; ">
                            <asp:CheckBox ID="useInquiry" runat="server" Height="1px" ForeColor="Silver"
                                ...
                                Font-Size="X-Small"
                                style="cursor: pointer; width: 180px; height: 40px; white-space: nowrap; overflow-x: hidden; text-overflow: ellipsis;" onclick="useInquiryClick();" />
                        </td>
                        <td style="padding: 2px; border: solid 1px silver; text-align: center;">
