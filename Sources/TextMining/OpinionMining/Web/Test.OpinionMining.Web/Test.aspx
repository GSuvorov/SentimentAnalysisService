<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test.aspx.cs" Inherits="Test.OpinionMining.Web.Test" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Opinion-Mining: Супер-Тест</title>
    <style type="text/css">
        .customFile
        {
            position: absolute;
    ...
    <script type="text/javascript">
        ...
        function disable_controls() {
            ...
            document.getElementById("<%= ruleCategoryDropDownList.ClientID %>").disabled = true;
...
<body>
    ...
    <div style="text-align: center;">
        ...
        <br />
        <br />
        <asp:DropDownList ID="ruleCategoryDropDownList" runat="server" Style="cursor: hand;">
            <asp:ListItem Selected="True" Value="All"            Text="проверить: Все правила" />
            <asp:ListItem                 Value="IndirectSpeech" Text="только: 'Indirect-speech' правила" />
            <asp:ListItem                 Value="DirectSpeech"   Text="только: 'Direct-speech'   правила" />
        </asp:DropDownList>
        <br />
        <br />
        <asp:CheckBox ID="showOnlyErrorCheckBox" runat="server" Text="показывать только ошибки"
            Checked="true" Style="cursor: hand;" />
        <hr />
    </div>
