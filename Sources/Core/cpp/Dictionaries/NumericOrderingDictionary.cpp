...
///////////////////////////////////////////////////////////////////////////////
// class CNumericOrderingDictionary
///////////////////////////////////////////////////////////////////////////////
void CNumericOrderingDictionary::Init( IAMConverterMorpho *pAMConverter )
{
	SS_TRY
	{
      ...
      pAMConverter->Code( DATA_TYPE::NAMES::ednOrderingEnglish, &oMorphoFeature, &m_rgMorphoParams[0].MorphoInfo, &m_rgMorphoParams[0].PartOfSpeech );
	}
	SS_CATCH(L"")
}
///////////////////////////////////////////////////////////////////////////////

inline bool CNumericOrderingDictionary::GetWordByDictIndex(
...
)
{
	...
	if(Index.GetDictionaryNumber() != DATA_TYPE::NAMES::ednOrderingEnglish)
		return false;

   bool RetVal = Detail::CNumericOrderingConverter::FromNumber( Index.GetId(), wcWord, Constants::MAX_CHARS_IN_WORD ) != 0;
...
bool CNumericOrderingDictionary::IsExistWord(/*in*/const wchar_t* wcWord)
{
	APL_ASSERT( wcWord != 0 );
	SS_TRY
	{
		...
		if( 
			wcWord == pLast ||
			Detail::CNumericOrderingConverter::ToNumber( wcWord, pLast, Number ) != pLast ||
...
bool CNumericOrderingDictionary::GetWordInfo/*ByWord*/(
...
bool CNumericOrderingDictionary::GetWordInfo/*ByWordIndex*/(
...
bool CNumericOrderingDictionary::GetWord(
			 /*in*/SWordIndex* pWordIndex,
			 /*out*/wchar_t* wcWord
)
{
...
bool CNumericOrderingDictionary::GetWordSource(
...
bool CNumericOrderingDictionary::GetWordFormsByIDSource(
