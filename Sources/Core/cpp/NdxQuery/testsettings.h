...
const wchar_t*	wszSettings			= L"SETTINGS";
///	инвадидное значение
const wchar_t*	wszInvalidValue		= L"__INVALID_VALUE__";
///	пустая строка
const wchar_t*	wszEmptyString		= L"";
///	слеш
const wchar_t*	wszSlash			= L"\\";
///	ini-file extension 
const wchar_t*	wszIniExt			= L".ini";

//	рабочая директория
const wchar_t*	wcszKey_PathWork = L"PATH_WORK";
//	директория с базой данных ( без слеша )
const wchar_t*	wcszKey_PathDatabase = L"PATH_DATABASE";
//	название папки с которой работаем в директории БД (Ind XXXXXXX)
const wchar_t*	wcszKey_NameInd = L"NAME_IND";
//	название (короткое) файла с запросами, он находится там же где EXE тестилки
const wchar_t*	wcszKey_TxtQueries = L"QUERIES_FILE_NAME";
