...
namespace Enumerators
{
	...
	template <class T> class TListEnumerator : virtual public SS::Interface::Enumerators::IEnumerator
	{
		/*! \typedef TCollection
		...
		*/
		...
		typename TListEnumerator<T>::TCollection::iterator it_currElement;
